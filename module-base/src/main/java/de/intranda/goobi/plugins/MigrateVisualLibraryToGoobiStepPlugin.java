...
public class MigrateVisualLibraryToGoobiStepPlugin implements IStepPluginVersion2 {
    ...
    public void initialize(Step step, String returnPath) {
        ...
        log.info("MigrateVisualLibraryToGoobi step plugin initialized");
    }
    ...
    public String getPagePath() {
        return "/uii/plugin_step_migrate_visual_library_to_goobi.xhtml";
    }
    ...
    public PluginReturnValue run() {
        ...
        log.info("MigrateVisualLibraryToGoobi step plugin executed");
        if (!successful) {
